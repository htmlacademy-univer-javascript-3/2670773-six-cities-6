...
Комментарий для контрольного MR, чтобы в пайплайне формировалась ссылка на проект. 
...
```
git remote add academy git@github.com:htmlacademy-univer-javascript-3/2670773-six-cities-6.git
```
